<section id="features" class="bg-blue-100">
    <div x-data="{ tech: 'blade' }" class="w-full max-w-5xl mx-auto px-4 sm:px-12 pt-12 pb-24">
        ...
        <div class="mt-12 grid grid-cols-1 md:grid-cols-2 gap-16">
            ...
            <div>
                ...
                <ul class="font-medium mt-2 list-disc list-outside pl-4  leading-snug  grid gap-2">
                    ...
                    <li>Built on rock solid foundation of <a class="underline" href="{{spatieUrl('https://spatie.be/docs/laravel-medialibrary/v9/introduction')}}">Media Library</a> which has been downloaded over three million times.</li>
                </ul>
            </div>
        ...
        <div class="mt-24 flex justify-center space-x-8 pt-8 border-t-8 border-blue-200">
            <a href="{{spatieUrl('https://spatie.be/docs/laravel-medialibrary/v9/handling-uploads-with-media-library-pro/introduction')}}" class="underline text-xl font-medium hover:text-blue-600">Read the docs</a>
