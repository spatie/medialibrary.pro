        ...
        <div class="mt-12 grid grid-cols-1 md:grid-cols-2 gap-16">
            ...
            <div>
                ...
                <ul class="font-medium mt-2 list-disc list-outside pl-4  leading-snug  grid gap-2">
                    ...
                    <li>You can use the components inside your Blade views, no Livewire knowledge needed. Alternatively, you can also use them within Livewire 4 components</li>
