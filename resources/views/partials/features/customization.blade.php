<div>
    ...
    <div class="code-center">
        <div x-show="tech === 'blade'">
            <pre><code class="html">&lt;!-- Livewire 4 and Blade --&gt;
...
&lt;/media-library-collection&gt;
    ...
    <p x-show="tech === 'vue'">
        Learn how to <a class="underline" href="{{spatieUrl('https://spatie.be/docs/laravel-medialibrary-pro/v6/vue/creating-custom-components')}}">create custom Vue components</a>.
    </p>
    <p x-show="tech === 'react'">
        Learn how to <a class="underline" href="{{spatieUrl('https://spatie.be/docs/laravel-medialibrary-pro/v6/react/creating-custom-components')}}">create custom React components</a>.
    </p>
</div>
