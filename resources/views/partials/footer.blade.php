<footer class="flex-1 -mt-24 pt-32 px-4 sm:px-16 text-blue-300 bg-blue-900">
    <div class="py-16 flex flex-col sm:flex-row justify-around items-center text-xs text-center leading-none font-medium">
        <ul class="sm:w-1/2 flex items-center justify-center sm:justify-end space-x-4">
