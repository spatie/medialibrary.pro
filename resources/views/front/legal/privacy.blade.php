...
@section('description', 'Privacy & cookie policy for Medialibrary Pro — learn how to create your own Laravel packages')
...
- Category 1 and 4: maintaining and improving the website and the creation of anonymous statistics (the identity of particular persons or companies will not be traceable) based on the “legitimate interest” of Medialibrary Pro to improve the service and website.
- Category 2: managing your account on the website to purchase the Medialibrary Pro Video Course.
...
Spatie may use your email address to send marketing as well as other news relating to the Medialibrary Pro if you subscribed the direct mailing list with consent. You can withdraw your consent at any time, without any reasoning and free of charge by, for example, clicking on the unsubscribe button provided at the bottom of each promotional email message.
...
4.1. Spatie will store your data only for a period that is necessary for the processing purpose. Your account data will be stored as long as your Medialibrary Pro account is activated. In case you have subscribed to our newsletter, we will store your data as long as you have not unsubscribed without exceeding five years.
...
6.2. Spatie shall not be liable in any way for direct or indirect damages caused by a wrongful or improper use of the Medialibrary Pro Video Course by a third party.

6.3. At any time, you must comply with the safety standards, for instance, by avoiding all non-authorized access you Medialibrary Pro account that is required to buy the Video Course on the website. You are solely responsible for the use of your own account.
