...
@section('description', 'Terms of use for Media Library Pro')
...
These Media Library Pro terms of use (the “Terms of Use”) apply to all services provided through <https://medialibrary.pro/> by Spatie BV, with registered offices at Kruikstraat 22/12, 2060 Antwerp, Belgium and registered at the CBE under number BE 0809.387.596 hereafter referred to as “Media Library Pro” “we”, “us” or “our”.
...
We shall make sure that the latest version of these Terms of Use shall always be available on <https://medialibrary.pro/terms-of-use>.

If you have any questions or concerns, you may contact us by email at [support@spatie.be](mailto:support@spatie.be).

## 1. Definitions

The following definitions apply to these Terms of Use:

1. “Fee”: the amount to be paid to Spatie to obtain a Software License for one year . This fee shall always be available at <https://medialibrary.pro>;
2. “Software”: the Media Library Pro software as a software product listed and described on <https://medialibrary.pro>, including all present and future bug fixes, corrections, updates, upgrades, modifications, new features or functionalities and documentation;
3. “Software License”: the non-exclusive, non-transferable, limited right to access, use and download the Media Library Pro Software in accordance with these Terms of Use;
4. “Terms of Use”: these terms of use;
5. “You”: any user of the Software.

## 2. Content of the Software

2.1. By accepting these Terms of Use, the Media Library Pro grants You access to the Software after the payment of the Fee. You can always read the content of the Software and all of its features at: <https://medialibrary.pro>.
...
3.6. The Software License for a single application is always bound to one Laravel application.

3.7. If You want to use the Software in multiple Laravel applications, You shall need the unlimited applications Software License or buy another single application Software License.

3.8. The Software License for unlimited applications has no limits on the number of Laravel applications You will use it for. 

3.9. You shall be able to determine which single application Software License belongs to which Laravel application.

3.10. Media Library Pro provides the following purchasing options:

- The Media Library Pro single application Software License: this package shall contain the Media Library Pro install package for one Laravel application and extra footage about the use of the Software.
- The Media Library Pro unlimited applications Software License: this package shall contain the Media Library Pro install package for unlimited Laravel applications and extra footage about the use of the Software.

More info about the different purchase options is available at <https://medialibrary.pro>.

3.11. For purchasing the Software, a valid email address is needed.

## 4. Use of the Software

4.1. Spatie is the owner or licensee of all rights in relation to the Software as a result of which all Software is copyrighted under applicable law.
...
4.7. You shall not use our Software in a manner or for any purpose that is contrary to a law or other regulation, or for a transfer of data that is or may be illegal, defamatory, intimidating, invasive or harmful to the privacy of third parties , or contains viruses, or violates or may violate the intellectual property rights or other rights of the Media Library Pro, its licensors or other individuals or entities.
...
7.1. All payments concerning the purchase of the Software License shall be handled by [Paddle](https://paddle.com/) in accordance with its terms and conditions. Paddle handles all payments through <https://spatie.be/products> by using Paddle’s SDK. Spatie does not store any of your payment details.
...
8.2. Spatie does not store any user data. According to the General Data Protection Regulation, Spatie itself cannot be considered a data processor. The Media Library Pro doesn’t save any data of its users. Any personal data that we may collect shall be processed in accordance with our privacy policy. By using our Software, You consent with this privacy policy.

8.3. Intellectual property rights protect the installation packages of the Software.

8.4. It is forbidden to use the Software to (try to) develop your own SaaS which sole purpose is to create UI elements for spatie/laravel-medialibrary. Spatie reserves all its rights to take legal action if You try to convert the Software to create Your own SaaS.
