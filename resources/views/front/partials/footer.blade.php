<footer class="flex-1 bg-blue-800">
    <div class="absolute inset-0 overflow-hidden">
        <div class="absolute inset-0">
            <img loading="eager" class="absolute w-full h-full" srcset="/images/footer-3000.jpg 3000w,
    ...
    <div class="layout-col pt-32 pb-24">
        <div class="grid md:cols-auto items-end gap-16">
            <div class="text-light-900">
                <h3 class="mt-12 markup-h1">
                    Need more info?
                </h3>
                <p class="markup-baseline">We're here from 9 to 17h <span class="text-sm">(CET)</span></p>
                <ul class="mt-12 grid gap-3">
                    <li>
                        <a href="https://github.com/spatie/mailcoach-support/issues" class="grid cols-auto gap-3 items-center justify-start text-light-900 hover:text-white">
                            <span class="flex w-8 h-8 text-base bg-blue-900 text-white-900 place-center rounded-full">
                    ...
                    <li>
                        <a href="https://twitter.com/getmailcoach" class="grid cols-auto gap-3 items-center justify-start text-light-900 hover:text-white">
                            <span class="flex w-8 h-8 text-base bg-blue-900 text-white-900 place-center rounded-full">
                    ...
                    <li>
                        <a href="mailto:mailcoach@spatie.be" class="grid cols-auto gap-3 items-center justify-start text-light-900 hover:text-white">
                            <span class="flex w-8 h-8 text-base bg-blue-900 text-white-900 place-center rounded-full">
                                <i class="far fa-envelope"></i>
                            </span>
                            Mail to mailcoach@spatie.be
                        </a>
                    </li>
                </ul>
            </div>
            <div class="text-xs md:justify-self-end">
                <ul class="grid cols-auto gap-4 items-center justify-start">
